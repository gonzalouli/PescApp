...
import { IonButton, IonContent, IonDatetime, IonHeader, IonInput, IonItem, IonLabel, IonList, IonPage, IonRefresher, IonRefresherContent, IonTitle } from '@ionic/react'
...
export default function Meteorology() {
    ...
    const miUbicacion = async()=>{
        ...
        setMiUbicacion(true);
        setTimeout(()=>{setMiUbicacion(false)},2000)
    ...
    return (
        ...
        <IonContent>
            <IonList className="container">
                <IonButton className="button miUbicacion" onClick={miUbicacion}>Mi ubicación</IonButton>
                {MiUbicacion && 
                    <IonItem>
            ...
            <div className="submit buttons">
                    <IonList className="submit buttons">
                        <IonItem >
                            <IonButton className="save"  onClick={searchMeteorology}>Buscar</IonButton>
                        </IonItem>
                    </IonList>
                </div>
        </IonContent>
